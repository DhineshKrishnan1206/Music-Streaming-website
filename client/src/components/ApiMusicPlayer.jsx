...
const ApiMusicPlayer = ({ songUrl, songNameFromAPI, songImageFromAPI ,albumNameFromAPI,artistName}) => {
  ...
  const handleNextSong = () => {
    ...
    // You can increment the currentSongIndex here
    setCurrentSongIndex(currentSongIndex + 1);
  };

  const handlePreviousSong = () => {
    // Implement logic to play the previous song
    // You can decrement the currentSongIndex here
    setCurrentSongIndex(currentSongIndex - 1);
  };
  return (
    <div
      ...
      <div className={`flex items-center w-full gap-3 ${minimized ? 'hidden' : ''}`}>
        ...
        <div className="flex-1">
          ...
          <AudioPlayer
            ...
            onClickNext={handleNextSong} // Handle next song
            onClickPrevious={handlePreviousSong} // Handle previous song
          />
        </div>
      </div>
    </div>
