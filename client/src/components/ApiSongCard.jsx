  ...
  return (
    <div className="flex justify-between">
      ...
      <motion.div
        ...
        className="w-1/2 h-auto px-4 py-4 cursor-pointer hover:shadow-xl hover:bg-card bg-gray-100 shadow-md rounded-lg flex flex-col items-center mt-4"
      >
        <div className="w-90 rounded-lg drop-shadow-lg relative overflow-hidden">
          <motion.img
            src={imageURL}
            alt=""
